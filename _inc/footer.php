<div class="announcement-msg infooter">
  <p>কম্পিউটার কোড টিউটোরিয়াল সাইট <a href="http://code.imaginativeworld.org" target="_blank">ইমাজিনেটিভ ওয়ার্ল্ড কোড</a> উন্মুক্ত করা হয়েছে!</p>
</div>
<footer>
  <div class="bg-footer">
    <div class="content" id="footer-block">
      <div class="content fixed-width">
        <div class="footercolumn firstcolumn">
          ...
          <div class="footer-box-text">
            <ul class="big-font">
              ...
              <li><a href="/products/index.php#tools">More Tools</a></li>
            </ul>
        ...
        <div class="footercolumn center-text">
          ...
          <div class="footer-box-feed footer-box-text bn-text">
  ...
  <div class="footerline content full-wide cur-default">
    <p>Copyright © 2014 <a href="http://imaginativeworld.org">Imaginative World</a>. All rights reserved. <abbr title="Created with <3 and HTML5"><span class="fa html5 fa-html5"></span></abbr> Coded by <a href="http://shohag.imaginativeworld.org">Md. Mahmudul Hasan Shohag</a></p>
  </div>
</footer>
</body></html>